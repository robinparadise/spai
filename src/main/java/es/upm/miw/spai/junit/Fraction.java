...
public class Fraction {
    /**
     * Conceptos: Las fracciones propias son aquellas cuyo numerador es menor
     * que el denominador
     * 
     * Las fracciones impropias son aquellas cuyo numerador es mayor que el
     * denominador
     * 
     * Dos fracciones son equivalentes cuando el producto de extremos (numerador
     * de la primera por denominador de la segunda) es igual al producto de
     * medios (denominador de la primera por el numerador de la segunda)
     * 
